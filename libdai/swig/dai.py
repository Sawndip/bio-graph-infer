...
class SmallSetVar:
    ...
    def insert(*args): return apply(_dai.SmallSetVar_insert, args)
    def erase(*args): return apply(_dai.SmallSetVar_erase, args)
    ...
    def back(*args): return apply(_dai.SmallSetVar_back, args)
...
class Prob:
    ...
    def resize(*args): return apply(_dai.Prob_resize, args)
    def get(*args): return apply(_dai.Prob_get, args)
    def set(*args): return apply(_dai.Prob_set, args)
    ...
    def __lt__(*args): return apply(_dai.Prob___lt__, args)
    def __eq__(*args): return apply(_dai.Prob___eq__, args)
...
class Factor:
    ...
    def set(*args): return apply(_dai.Factor_set, args)
    def get(*args): return apply(_dai.Factor_get, args)
    def p(*args): return apply(_dai.Factor_p, args)
    def vars(*args): return apply(_dai.Factor_vars, args)
    def nrStates(*args): return apply(_dai.Factor_nrStates, args)
    ...
    def sumAbs(*args): return apply(_dai.Factor_sumAbs, args)
    ...
    def __eq__(*args): return apply(_dai.Factor___eq__, args)
    def __neg__(*args): return apply(_dai.Factor___neg__, args)
    ...
    def takeAbs(*args): return apply(_dai.Factor_takeAbs, args)
    def takeExp(*args): return apply(_dai.Factor_takeExp, args)
    def takeLog(*args): return apply(_dai.Factor_takeLog, args)
...
class GraphAL:
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        this = apply(_dai.new_GraphAL, args)
        try: self.this.append(this)
        except: self.this = this
    def nb(*args): return apply(_dai.GraphAL_nb, args)
    def addNode(*args): return apply(_dai.GraphAL_addNode, args)
    def addEdge(*args): return apply(_dai.GraphAL_addEdge, args)
    def eraseNode(*args): return apply(_dai.GraphAL_eraseNode, args)
    def eraseEdge(*args): return apply(_dai.GraphAL_eraseEdge, args)
    def nrNodes(*args): return apply(_dai.GraphAL_nrNodes, args)
    def nrEdges(*args): return apply(_dai.GraphAL_nrEdges, args)
    def hasEdge(*args): return apply(_dai.GraphAL_hasEdge, args)
    def findNb(*args): return apply(_dai.GraphAL_findNb, args)
    def nbSet(*args): return apply(_dai.GraphAL_nbSet, args)
    def isConnected(*args): return apply(_dai.GraphAL_isConnected, args)
    def isTree(*args): return apply(_dai.GraphAL_isTree, args)
    def checkConsistency(*args): return apply(_dai.GraphAL_checkConsistency, args)
    def __eq__(*args): return apply(_dai.GraphAL___eq__, args)
    def printDot(*args): return apply(_dai.GraphAL_printDot, args)
...
class BipartiteGraph:
    ...
    def hasEdge(*args): return apply(_dai.BipartiteGraph_hasEdge, args)
    def findNb1(*args): return apply(_dai.BipartiteGraph_findNb1, args)
    def findNb2(*args): return apply(_dai.BipartiteGraph_findNb2, args)
    def nb1Set(*args): return apply(_dai.BipartiteGraph_nb1Set, args)
    def nb2Set(*args): return apply(_dai.BipartiteGraph_nb2Set, args)
    ...
    def __eq__(*args): return apply(_dai.BipartiteGraph___eq__, args)
...
class FactorGraph:
    ...
    def bipGraph(*args): return apply(_dai.FactorGraph_bipGraph, args)
    ...
    def MarkovGraph(*args): return apply(_dai.FactorGraph_MarkovGraph, args)
    def isMaximal(*args): return apply(_dai.FactorGraph_isMaximal, args)
    def maximalFactor(*args): return apply(_dai.FactorGraph_maximalFactor, args)
    def maximalFactorDomains(*args): return apply(_dai.FactorGraph_maximalFactorDomains, args)
    def logScore(*args): return apply(_dai.FactorGraph_logScore, args)
...
class Permute:
    ...
    def ranges(*args): return apply(_dai.Permute_ranges, args)
    def inverse(*args): return apply(_dai.Permute_inverse, args)
...
class multifor:
    ...
    def reset(*args): return apply(_dai.multifor_reset, args)
